export const BRAND = {
  company: "ADN Capital",
  platform: "ADN Capital",
  aiPersona: "AIDEN",
  name: "ADN Capital",
  legalName: "ADN Capital",
  tagline: "Analyst. Discipline. Network.",
  positioning: "Hệ sinh thái AI đầu tư cho chứng khoán Việt Nam.",
  persona: "AIDEN",
} as const;

export const PRODUCT_NAMES = {
  platform: "ADN Capital",
  suite: "Hệ sinh thái ADN",
  assistant: "AIDEN",
  advisory: "ADN AIDEN",
  advisoryShort: "AIDEN",
  market: "ADN Pulse",
  ...
  art: "ADN ART",
  risk: "ADN Guard",
  guardrails: "ADN Guard",
  portfolio: "ADN Vault",
  broker: "ADN x DNSE",
  brokerConnect: "ADN x DNSE",
  aiBroker: "ADN Radar",
  brokerWorkflow: "ADN Radar",
  backtest: "ADN Lab",
  alerts: "ADN Sentinel",
  notifications: "ADN Sentinel",
  workflow: "ADN Flow",
  brief: "AIDEN Brief",
  diary: "ADN Diary",
} as const;
...
export const PRODUCT_TAGLINES = {
  platform: "Hệ sinh thái AI đầu tư cho chứng khoán Việt Nam.",
  ...
  aiBroker: "Theo dõi cơ hội giao dịch qua lớp kiểm soát.",
  backtest: "Kiểm chứng chiến lược trước khi thực chiến.",
  alerts: "Cảnh báo tín hiệu, rủi ro và cập nhật hệ thống.",
...
export const PRODUCT_DESCRIPTIONS = {
  ...
  brokerConnect: "Kết nối tài khoản DNSE, kiểm tra sức mua và đặt lệnh có kiểm soát.",
...
export const ROUTE_DISPLAY_NAMES: Record<string, { title: string; breadcrumb: string }> = {
  ...
  "/aiden": { title: PRODUCT_NAMES.advisory, breadcrumb: "Sản phẩm - Tư vấn đầu tư" },
  "/dashboard/signal-map": { title: PRODUCT_NAMES.signalMap, breadcrumb: "Sản phẩm - ADN Radar" },
  "/dashboard/dnse-trading": { title: PRODUCT_NAMES.brokerConnect, breadcrumb: "Sản phẩm - Đặt lệnh ADN x DNSE" },
  ...
  "/products": { title: "Sản phẩm", breadcrumb: `${BRAND.name} - Bộ công cụ` },
