...
function buildPrompt(input: MorningRewriteInput) {
  ...
  return [
    ...
    "Nhiệm vụ: viết lại bản tin thành các gạch đầu dòng có phân tích, không chỉ chép tiêu đề.",
    ...
    "Schema bắt buộc:",
    '{"vn_market":["..."],"macro":["..."],"risk_opportunity":["..."]}',
    "Yêu cầu nội dung:",
    "- vn_market: 4-6 ý, gom theo nhóm ngành/mã nổi bật, mỗi ý có ý nghĩa tác động tới thị trường.",
