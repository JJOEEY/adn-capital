...
function buildPrompt(input: MorningRewriteInput) {
  ...
  return [
    ...
    "Yêu cầu nội dung:",
    "- vn_market: 4-6 ý, gom theo nhóm ngành/mã nổi bật, mỗi ý nói rõ câu chuyện và tác động tới dòng tiền.",
    "- macro: 3-5 ý, tách rõ vĩ mô trong nước và vĩ mô quốc tế nếu có dữ liệu macro/global.",
    "- risk_opportunity: 3-5 ý, phải có 'Xu hướng thị trường', rủi ro, cơ hội và nhận định chung cho phiên tới.",
    "- Không trả các dòng kiểu '30 phút trước', '58 phút trước', hoặc chỉ liệt kê tiêu đề.",
    "",
    "Dữ liệu hiện có:",
    JSON.stringify({
