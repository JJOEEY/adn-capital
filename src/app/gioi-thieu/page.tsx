/**
 * /gioi-thieu — Giới thiệu ADN Capital. Warm-editorial UX (marketing Shell/theme).
 */
...
const TOOLS = [
  ...
  { name: "ADN Radar", href: "/products/adn-radar" },
        ...
        <div className="mx-auto max-w-[1180px] px-5 py-16 sm:px-8 lg:py-20">
          <Reveal>
            <div className="flex flex-wrap items-end justify-between gap-4">
              ...
              <a href="/products" className="inline-flex items-center gap-1.5 text-[15px] font-semibold text-[var(--moss)]">Xem tất cả <ArrowRight className="h-4 w-4" strokeWidth={2} /></a>
            </div>
          </Reveal>
          <Reveal delay={0.06}>
