...
function AuthPageShell({ children, compactApp = false }: { children: React.ReactNode; compactApp?: boolean }) {
  if (compactApp) {
    return (
      <main
      ...
      >
        <div className="mx-auto flex min-h-[calc(100dvh-4rem)] w-full max-w-md flex-col justify-center">
          <div className="mb-6 text-center">
            <Image src="/brand/favicon.png" alt="ADN Capital" width={56} height={56} className="mx-auto rounded-2xl" priority />
            <h1 className="mt-4 text-2xl font-black tracking-[-0.04em]">Đăng nhập ADN Capital</h1>
            <p className="mt-2 text-sm leading-6" style={{ color: "var(--text-secondary)" }}>
              Đăng nhập để mở dashboard, tin tức, ADN AI Broker và ART trong app.
            </p>
          </div>
          {children}
        </div>
