/**
 * /design-preview — landing rebuilt in a warm premium-editorial UX (inspired by the
...
const FEATURES = [
  {
    ...
    href: "/design-preview/products/aiden",
  ...
  },
  {
    ...
    href: "/design-preview/products/art",
...
const TOOLS = [
  { icon: Radar, title: "ADN Radar", desc: "Bản đồ tín hiệu cả thị trường, mã nào Mua mã nào Bán.", href: "/design-preview/products/radar", img: "/hero-showcase/app-adn-radar-real.png" },
  { icon: TrendingUp, title: "Xếp hạng RANK", desc: "Xếp cổ phiếu theo sức mạnh tương đối, thấy ngay nhóm dẫn dắt.", href: "/design-preview/products/rank", img: "/hero-showcase/app-adn-rank-real.png" },
  { icon: BarChart3, title: "Cổ phiếu & RS", desc: "Tra cứu từng mã với sức mạnh tương đối và dòng tiền.", href: "/design-preview/products/co-phieu", img: "/hero-showcase/app-adn-stock-real.png" },
  { icon: Wallet, title: "Ký quỹ Margin", desc: "Đòn bẩy linh hoạt, lãi suất từ 5,99% một năm, minh bạch.", href: "/design-preview/products/margin", img: null },
];
