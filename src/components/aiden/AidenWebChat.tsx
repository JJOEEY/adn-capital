  ...
  return (
    <MainLayout disableSwipe>
      <div className="flex h-full min-h-0 flex-col bg-[var(--background)]">
        <div className="flex items-center justify-between border-b border-[var(--border)] bg-[var(--surface)] px-4 py-3 md:px-6">
        ...
        <div className="border-t border-[var(--border)] bg-[var(--surface)] px-4 py-3 md:px-6">
          <form onSubmit={handleSubmit} className="mx-auto flex max-w-4xl items-end gap-2">
            <textarea
              ...
              className="max-h-40 min-h-[44px] flex-1 resize-none rounded-2xl border border-[var(--border)] bg-[var(--background)] px-4 py-3 text-sm leading-5 text-[var(--text-primary)] outline-none transition placeholder:text-[var(--text-muted)] focus:border-[var(--primary)] disabled:opacity-60"
            />
            <button
