...
const plans: PricingPlan[] = [
  {
    ...
    features: [
      ...
      { text: "Gợi ý cơ hội từ ADN Radar" },
      ...
      { text: "ADN Radar cảnh báo theo thời gian thực (mua/bán/quản trị vốn)", locked: true },
  ...
  },
  {
    ...
    features: [
      ...
      { text: "ADN Radar cảnh báo theo thời gian thực (mua/bán/quản trị vốn)" },
