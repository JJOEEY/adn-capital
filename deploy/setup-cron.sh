...
${CRON_DATABASE_ADN_SIGNAL_CORE_UNIVERSE_COLLECT_SCHEDULE:-20 8,15 * * 1-5} ${CURL_CMD} "${APP_URL}/api/cron?type=${CRON_DATABASE_ADN_SIGNAL_CORE_UNIVERSE_COLLECT:-database_adn_signal_core_universe_collect}&sync=1" >> ${LOG_DIR}/database_v2_adn_signal_core_universe_collect.log 2>&1
